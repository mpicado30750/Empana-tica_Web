...
namespace TotalHRInsight.Controllers
{
    ...
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(TotalHRInsightDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCategoria,NombreCategoria,Descripcion")] Categoria categoria)
        {
